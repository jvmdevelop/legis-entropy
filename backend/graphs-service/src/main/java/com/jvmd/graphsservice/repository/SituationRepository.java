...
public interface SituationRepository extends Neo4jRepository<Situation, String> {
    ...
    @Query("""
            MATCH (s:Situation {id: $id})
            SET s.generatedDocId = $docId,
                s.generatedDocTitle = $docTitle,
                s.updatedAt = $now
            RETURN s
            """)
    ...
    @Query("""
            ...
            """)
    void linkDocument(@Param("situationId") String situationId,
    ...
    @Query("""
            ...
            DELETE r
            """)
    void unlinkDocument(@Param("situationId") String situationId,
                        @Param("documentId") String documentId);
