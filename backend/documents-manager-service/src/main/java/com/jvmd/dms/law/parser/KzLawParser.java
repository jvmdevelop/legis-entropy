        ...
        for (String line : lines) {
            ...
            if (currentArticle != null) {
                ...
                if (currentClause != null) {
                    Matcher subcluseMatcher = SUBCLAUSE_PATTERN.matcher(trimmedLine);
                    if (subcluseMatcher.matches()) {
                        String label = subcluseMatcher.group(1).trim();
                        String text = subcluseMatcher.group(2).trim();
