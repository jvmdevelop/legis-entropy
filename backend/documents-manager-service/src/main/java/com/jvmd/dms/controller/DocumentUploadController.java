...
import com.jvmd.dms.service.DocumentUploadService;
...
public class DocumentUploadController {
    ...
    public ResponseEntity<DocumentUploadService.DocumentUploadResult> uploadDocument(
        ...
        try {
            DocumentUploadService.DocumentUploadResult result = documentUploadService.processDocument(file, workspaceId, userId);
