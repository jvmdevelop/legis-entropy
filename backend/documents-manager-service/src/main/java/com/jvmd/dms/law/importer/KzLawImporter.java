package com.jvmd.dms.law.importer;

import com.jvmd.dms.law.model.kz.*;
import com.jvmd.dms.law.parser.KzLawParser;
...
public class KzLawImporter {
    ...
    public void importSampleKzLaws() {
        ...
        Code ukCode = importCode("УК", "Уголовный Кодекс Республики Казахстан", "141-VI ЗРК");
        Code gkCode = importCode("ГК", "Гражданский Кодекс Республики Казахстан", "997-I ЗРК");
        Code pkCode = importCode("ПК", "Процессуальный Кодекс Республики Казахстан", "206-IV ЗРК");
        Code nkCode = importCode("НК", "Налоговый Кодекс Республики Казахстан", "227-IV ЗРК");
        Code tkCode = importCode("ТК", "Трудовой Кодекс Республики Казахстан", "251-V ЗРК");
