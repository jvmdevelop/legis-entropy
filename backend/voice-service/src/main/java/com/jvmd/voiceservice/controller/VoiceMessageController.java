package com.jvmd.voiceservice.controller;

import com.jvmd.voiceservice.dto.VoiceMessageDTO;
import com.jvmd.voiceservice.service.VoiceMessageService;
...
public class VoiceMessageController {
    ...
    public ResponseEntity<VoiceMessageDTO> get(@PathVariable String id) {
        return voiceService.get(id).map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
    }
