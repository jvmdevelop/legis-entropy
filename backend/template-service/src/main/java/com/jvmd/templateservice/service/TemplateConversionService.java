...
public class TemplateConversionService {
    ...
    public record ConversionResult(String sourceFormat, String canonicalMarkdown) {}
    ...
    public ConversionResult convert(MultipartFile file) {
        ...
        try {
            ...
            if ("MD".equals(format) || "TXT".equals(format)) {
                ...
                ByteArrayResource resource = new ByteArrayResource(file.getBytes()) {
                    ...
                    public String getFilename() {
                        return name.isBlank() ? "template." + ext.toLowerCase(Locale.ROOT) : name;
                    }
                };
            ...
            log.error("Template conversion failed for {}: {}", name, e.getMessage(), e);
            throw new IllegalStateException("Не удалось распознать шаблон: " + e.getMessage(), e);
        }
    }
